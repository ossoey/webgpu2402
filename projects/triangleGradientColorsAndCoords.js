...
const triangleGradientColorsAndCoords = (params = {context:{}}) => {
    let ops = {};

    
    ops.desc = "Triangle Gradient colors and coords";
    ...
    ops.iniData = () => {
        ...
        @vertex fn vs(@location(0) coords: vec2f, @location(1) color: vec3f )-> VertexOut {

          var vertexOut : VertexOut; 
          
          vertexOut.pos = vec4f(coords, 0.0, 1.0);
...
export {triangleGradientColorsAndCoords}
export default triangleGradientColorsAndCoords;