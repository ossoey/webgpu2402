        ...
        ops.iniData = () => {
            ops.env.shaderCode = Ebk.Matrix.shaderUtils +` ` 
               ...
               @vertex fn vs(@builtin(instance_index) ii : u32, @builtin(vertex_index) vi : u32)-> VertexTransfer {
                ...
                melange = applyLightOnVertex(ld1);
                ...
                melange = applyLightOnVertex(ld2);
                ...
                melange = applyLightOnVertex(ld3);
                ...
                melange = applyLightOnVertex(ld4);
                ...
                melange = applyLightOnVertex(ld5);
