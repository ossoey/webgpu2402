...
Ebk.UI =  {
    ...
    createAndAddElementFirstPosition : (params={container: {}, properties: {}, elementType: "div"  }    ) => {
      // Parameter checks
      // if (!params || !params.container || !params.properties || typeof params.properties !== 'object' || typeof params.elementType !== 'string') {
      //   console.error('Invalid parameters. Expected an object with container and properties.');
      //   return null;
      ...
      params.container.insertBefore(newElement, params.container.firstChild);
    ...
    editElement : (params={element: {},  properties: {} }    ) => {
      // Parameter checks
      // if (!params || !params.container || !params.properties || typeof params.properties !== 'object' || typeof params.elementType !== 'string') {
      //   console.error('Invalid parameters. Expected an object with container and properties.');
      //   return null;
  ...
  createElementFirstPosition_LabeledInput : (params= {
    ...
    // Create a <label> element with specified properties
    let labelElement = Ebk.UI.createAndAddElementFirstPosition ({container:  params.container, properties : params.labelProperties, elementType: 'label'});
    labelElement.textContent = params.labelProperties.text || '';
  ...
  createElementFirstPosition_LabeledVertexInputs : (params= {
  ...
  createElementFirstPosition_LabeledSelect : (params= {
